...
public class MainActivity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        } else if (mDatabaseDate.getList_Id().size() < 20) {
        ...
        if (mDatabaseDate.getList_Id().size() == 20) {
    ...
    public void downloadUrl(int number) {
        String url = "http://www.40dayswithchrist.com/uploads/20_days_with_1_Peter_-_Day_" + number + ".mp3";
...
// in order for this if to run, you must use the android 3.2 to compile your app
        ...
        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "/App/Peter/20_days_with_1_Peter_-_Day_" + number + ".mp3");
        data = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Download//App/Peter/20_days_with_1_Peter_-_Day_" + number + ".mp3";
...
// get download service and enqueue file
    ...
    protected void onDestroy() {
        ...
        Notification.Builder notificationBuilder=new Notification.Builder(getApplicationContext()).setTicker(
                "20 Days with 1 Peter").setSmallIcon(R.drawable.play).setAutoCancel(true)
